...
This means one can have an always-on kgsd instance running, and another local kgsd/kgs-qt instance which connects to this node and receives blocks from it.
