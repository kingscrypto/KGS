...
RESOURCES += src/qt/kgs.qrc src/qt/kgs_locale.qrc

TRANSLATIONS += src/qt/locale/kgs_bg.ts \
                src/qt/locale/kgs_de.ts \
                src/qt/locale/kgs_en.ts \
                src/qt/locale/kgs_es.ts \
                src/qt/locale/kgs_fi.ts \
                src/qt/locale/kgs_fr.ts \
                src/qt/locale/kgs_it.ts \
                src/qt/locale/kgs_ja.ts \
                src/qt/locale/kgs_pl.ts \
                src/qt/locale/kgs_pt.ts \
                src/qt/locale/kgs_ru.ts \
                src/qt/locale/kgs_sk.ts \
                src/qt/locale/kgs_sv.ts \
                src/qt/locale/kgs_vi.ts \
                src/qt/locale/kgs_zh_CN.ts \
                src/qt/locale/kgs_zh_TW.ts
