...
In order to support loading of multiple wallets in kgs-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kgs.cpp.
...
Changes to kgs.cpp
----------------------
kgs.cpp is the entry point into kgs-qt, and as such, will require some minor modifications to provide hooks for
