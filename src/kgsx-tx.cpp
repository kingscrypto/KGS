...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kgs Core kgs-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kgs-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kgs transaction") + "\n" +
                               "  kgs-tx [options] -create [commands]   " + _("Create hex-encoded kgs transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kgs transaction
