...
#ifndef KGS_ZKGSWALLET_H
#define KGS_ZKGSWALLET_H
...
public:
    CzKGSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZKGS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZKGS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
