...
/* Kgs GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KGS-Core"
#define QAPP_ORG_DOMAIN "kgscoin.io"
#define QAPP_APP_NAME_DEFAULT "KGS-Qt"
#define QAPP_APP_NAME_TESTNET "KGS-Qt-testnet"
