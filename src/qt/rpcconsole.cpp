                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKGSPathCustom = GetArg("-zkgsbackuppath", "");
    ...
    if(!strzKGSPathCustom.empty()) {
        ui->wallet_customzkgsbackuppath->setText(QString::fromStdString(strzKGSPathCustom));
        ui->wallet_customzkgsbackuppath_label->setVisible(true);
        ui->wallet_customzkgsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKGSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the KGS RPC console.") + "<br>" +
