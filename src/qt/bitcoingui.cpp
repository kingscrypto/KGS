                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KGS-Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kgs: URIs)"));
...
//     tabGroup->addAction(proposalAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KGS Core"), this);
    aboutAction->setStatusTip(tr("Show information about KGS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KGS"));
    ...
    openAction->setStatusTip(tr("Open a KGS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KGS Core help message to get a list with possible KGS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KGS Core client") + " " + networkStyle->getTitleAddText();
...
// {
//     proposalAction->setChecked(false);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KGS network", "", count));
}
...
{
    QString strTitle = tr("KGS-Core"); // default title
