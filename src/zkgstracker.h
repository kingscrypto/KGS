...
#ifndef KGS_ZKGSTRACKER_H
#define KGS_ZKGSTRACKER_H
...
public:
    CzKGSTracker(std::string strWalletFile);
    ~CzKGSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzKGSWallet* zKGSWallet = NULL);
