...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KGS features */
        {"kgs", "masternode", &masternode, true, true, false},
        {"kgs", "listmasternodes", &listmasternodes, true, true, false},
        {"kgs", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kgs", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kgs", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kgs", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kgs", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kgs", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kgs", "masternodedebug", &masternodedebug, true, true, false},
        {"kgs", "startmasternode", &startmasternode, true, true, false},
        {"kgs", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kgs", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kgs", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kgs", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kgs", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kgs", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kgs", "mnbudget", &mnbudget, true, true, false},
        {"kgs", "preparebudget", &preparebudget, true, true, false},
        {"kgs", "submitbudget", &submitbudget, true, true, false},
        {"kgs", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kgs", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kgs", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kgs", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kgs", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kgs", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kgs", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kgs", "checkbudgets", &checkbudgets, true, true, false},
        {"kgs", "mnsync", &mnsync, true, true, false},
        {"kgs", "spork", &spork, true, true, false},
        {"kgs", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzkgsseed", &getzkgsseed, false, false, true},
        {"zerocoin", "setzkgsseed", &setzkgsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzkgs", &searchdzkgs, false, false, true},
        {"zerocoin", "dzkgsstate", &dzkgsstate, false, false, true}
...
{
    return "> kgs-cli " + methodname + " " + args + "\n";
}
