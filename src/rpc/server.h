...
extern UniValue setzkgsseed(const UniValue& params, bool fHelp);
extern UniValue getzkgsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzkgs(const UniValue& params, bool fHelp);
extern UniValue dzkgsstate(const UniValue& params, bool fHelp);
