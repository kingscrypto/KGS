Contributing to KGS Core
============================

The KGS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KGS Core project, and is not to be
confused with overall KGS Network Protocol consensus changes.

Whether a pull request is merged into KGS Core rests with the project merge
...
Patches that change KGS consensus rules are considerably more involved than
...
Where a patch set proposes to change the KGS consensus, it must have been
...
The project leader is the release manager for each KGS Core release.
